...
export const createCatalogue = (catalogueData) => (dispatch) => {
  ...
  fetch('https://us-central1-cogeb-2469c.cloudfunctions.net/api_construction/catalogue/create', {
    method: 'POST',
...
export const getAllCatalogues = () => (dispatch) => {
  ...
  fetch('https://us-central1-cogeb-2469c.cloudfunctions.net/api_construction/catalogue/catalogues')
    .then((response) => response.json())
    .then((data) => dispatch({
...
export const getCatalogueById = (id) => async (dispatch) => {
    ...
    try {
      const response = await fetch(`https://us-central1-cogeb-2469c.cloudfunctions.net/api_construction/catalogue/catalogues/${id}`);
...
export const updateCatalogue = (id, catalogueData) => (dispatch) => {
  ...
  fetch(`https://us-central1-cogeb-2469c.cloudfunctions.net/api_construction/catalogue/update/${id}`, {
      method: 'PUT',
      body: formData,
  })
  .then(response => {
...
export const deleteCatalogue = (id) => (dispatch) => {
    ...
    fetch(`https://us-central1-cogeb-2469c.cloudfunctions.net/api_construction/catalogue/delete/${id}`, {
        method: 'DELETE',
    })
    .then(response => {
        if (!response.ok) {
...
export const countCatalogues = () => (dispatch) => {
  ...
  fetch('https://us-central1-cogeb-2469c.cloudfunctions.net/api_construction/catalogue/count')
    .then((response) => response.json())
    .then((data) => dispatch({
